...
let captionvid = `🎶 _*¡Disfruta de tu música gracias a ${gt}!*_ 🎶

➢ _*Título:*_ ${yt_play[0].title}
➢ _*Subido hace*_ ${yt_play[0].ago}
➢ _*Duración:*_ ${secondString(yt_play[0].duration.seconds)}
➢ _*Vistas:*_ ${MilesNumber(yt_play[0].views)}
➢ _*Enlace:*_ ${yt_play[0].url}

🕒 *¡Tu Audio se está preparando! Relájate y disfruta del momento...* 🎧✨`  
